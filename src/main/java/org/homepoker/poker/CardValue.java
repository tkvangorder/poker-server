...
public enum CardValue {
  ...
  private static final CardValue[] charToCardValue = new CardValue['U'];
  private static final Map<Integer, CardValue> maskToCardValue = new HashMap<>();
